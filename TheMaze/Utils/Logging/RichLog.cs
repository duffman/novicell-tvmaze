 ...
 * 
 *  Rich Logging 
 *  @autor Patrik Forsberg <patrik.forsberg@coldmind.com>
 *  
 *  Partly based on a blog post by Rick Stral:
...
namespace TheMaze.Utils.Logging
{
    public static class RichLog
    {
        ...
        public static void baseLog(string label, ConsoleColor? color = ConsoleColor.Black, Object data = null)
        {
            ...
            WriteLine("{label} :: {dataValue}", color);
        ...
        {
            baseLog(label, ConsoleColor.Green, data);
        }
